    ...
    <div className="min-h-screen bg-[#020617] text-white selection:bg-blue-500/30">
      ...
      <main className="max-w-6xl mx-auto py-20 px-6 grid grid-cols-1 md:grid-cols-2 gap-16">
        ...
        <div className="flex flex-col justify-center">
          <div className="text-blue-500 font-black uppercase tracking-[0.3em] text-xs mb-4">
            Produit Officiel
          </div>
          ...
          <p className="text-3xl font-black text-white mb-8 italic">
            ${produitPourClient.prix.toLocaleString()} <span className="text-sm not-italic text-blue-500">USD</span>
          </p>
